  ...
  return (
    ...
    >
      <div className="max-w-4xl xl:max-w-6xl mx-auto">
        ...
        >
          Quickly find your home you want using our effective search and
          filters!
        </motion.h2>
              ...
              <FeatureCard
                ...
                Description={
                  [
                    ...
                    "Find your perfect rental home with our advanced search and filter options",
                  ][index]
                }
                linkText={["Learn More", "Search", "Discover"][index]}
